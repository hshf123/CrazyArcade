...
{
	return BindParam(paramIndex, SQL_C_TINYINT, SQL_TINYINT, static_cast<int32>(sizeof(bool)), value, index);
}
...
{
	return BindParam(paramIndex, SQL_C_TINYINT, SQL_TINYINT, static_cast<int32>(sizeof(int8)), value, index);
}

bool DBConnection::BindParam(int32 paramIndex, int16* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_SHORT, SQL_SMALLINT, static_cast<int32>(sizeof(int16)), value, index);
}

bool DBConnection::BindParam(int32 paramIndex, int32* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_LONG, SQL_INTEGER, static_cast<int32>(sizeof(int32)), value, index);
}

bool DBConnection::BindParam(int32 paramIndex, int64* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_SBIGINT, SQL_BIGINT, static_cast<int32>(sizeof(int64)), value, index);
}

bool DBConnection::BindParam(int32 paramIndex, TIMESTAMP_STRUCT* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_TYPE_TIMESTAMP, SQL_TYPE_TIMESTAMP, static_cast<int32>(sizeof(TIMESTAMP_STRUCT)), value, index);
}
...
{
	return BindCol(columnIndex, SQL_C_TINYINT, static_cast<int32>(sizeof(bool)), value, index);
}

bool DBConnection::BindCol(int32 columnIndex, float* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_FLOAT, static_cast<int32>(sizeof(float)), value, index);
}

bool DBConnection::BindCol(int32 columnIndex, double* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_DOUBLE, static_cast<int32>(sizeof(double)), value, index);
}

bool DBConnection::BindCol(int32 columnIndex, int8* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_TINYINT, static_cast<int32>(sizeof(int8)), value, index);
}

bool DBConnection::BindCol(int32 columnIndex, int16* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_SHORT, static_cast<int32>(sizeof(int16)), value, index);
}

bool DBConnection::BindCol(int32 columnIndex, int32* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_LONG, static_cast<int32>(sizeof(int32)), value, index);
}

bool DBConnection::BindCol(int32 columnIndex, int64* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_SBIGINT, static_cast<int32>(sizeof(int64)), value, index);
}

bool DBConnection::BindCol(int32 columnIndex, TIMESTAMP_STRUCT* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_TYPE_TIMESTAMP, static_cast<int32>(sizeof(TIMESTAMP_STRUCT)), value, index);
}
