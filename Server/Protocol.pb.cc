...
PROTOBUF_CONSTEXPR S_ROOMBACK::S_ROOMBACK(
    ::_pbi::ConstantInitialized)
  : room_(nullptr){}
struct S_ROOMBACKDefaultTypeInternal {
  PROTOBUF_CONSTEXPR S_ROOMBACKDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~S_ROOMBACKDefaultTypeInternal() {}
  union {
    S_ROOMBACK _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 S_ROOMBACKDefaultTypeInternal _S_ROOMBACK_default_instance_;
}  // namespace Protocol
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_ROOMSTART, mapname_),
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::C_MOVE, frontpos_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_BOMBEND, destroyitemcellposes_),
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_ROOMBACK, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_ROOMBACK, room_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 147, -1, -1, sizeof(::Protocol::C_MOVE)},
  { 155, -1, -1, sizeof(::Protocol::S_MOVE)},
  { 164, -1, -1, sizeof(::Protocol::C_BOMB)},
  { 171, -1, -1, sizeof(::Protocol::S_BOMB)},
  { 179, -1, -1, sizeof(::Protocol::S_BOMBEND)},
  { 190, -1, -1, sizeof(::Protocol::S_ITEMSPAWN)},
  { 198, -1, -1, sizeof(::Protocol::S_DEAD)},
  { 206, -1, -1, sizeof(::Protocol::S_ITEMACQUISITION)},
  { 214, -1, -1, sizeof(::Protocol::S_GAMEEND)},
  { 221, -1, -1, sizeof(::Protocol::S_ROOMBACK)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::Protocol::_S_ROOMBACK_default_instance_._instance,
};
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "PRoom\022\017\n\007mapName\030\003 \001(\t\022#\n\005spawn\030\004 \003(\0132\024."
  "Protocol.PRoomStart\"]\n\006C_MOVE\022-\n\014positio"
  "nInfo\030\001 \001(\0132\027.Protocol.PPositionInfo\022$\n\010"
  "frontPos\030\002 \001(\0132\022.Protocol.PCellPos\"i\n\006S_"
  "MOVE\022\r\n\005force\030\001 \001(\010\022!\n\006player\030\002 \001(\0132\021.Pr"
  "otocol.PPlayer\022-\n\014positionInfo\030\003 \001(\0132\027.P"
  "rotocol.PPositionInfo\"-\n\006C_BOMB\022#\n\007cellP"
  "os\030\001 \001(\0132\022.Protocol.PCellPos\"P\n\006S_BOMB\022!"
  "\n\006player\030\001 \001(\0132\021.Protocol.PPlayer\022#\n\007cel"
  "lpos\030\002 \001(\0132\022.Protocol.PCellPos\"\345\001\n\tS_BOM"
  "BEND\022!\n\006player\030\001 \001(\0132\021.Protocol.PPlayer\022"
  "\'\n\013bombCellPos\030\002 \001(\0132\022.Protocol.PCellPos"
  "\0222\n\026destroyObjectCellPoses\030\003 \003(\0132\022.Proto"
  "col.PCellPos\0220\n\024destroyItemCellPoses\030\004 \003"
  "(\0132\022.Protocol.PCellPos\022&\n\013trapPlayers\030\005 "
  "\003(\0132\021.Protocol.PPlayer\"Y\n\013S_ITEMSPAWN\022#\n"
  "\007cellPos\030\001 \001(\0132\022.Protocol.PCellPos\022%\n\010it"
  "emType\030\002 \001(\0162\023.Protocol.PItemType\"U\n\006S_D"
  "EAD\022!\n\006player\030\001 \001(\0132\021.Protocol.PPlayer\022("
  "\n\007posInfo\030\002 \001(\0132\027.Protocol.PPositionInfo"
  "\"_\n\021S_ITEMACQUISITION\022%\n\nplayerInfo\030\001 \001("
  "\0132\021.Protocol.PPlayer\022#\n\007itemPos\030\002 \001(\0132\022."
  "Protocol.PCellPos\"0\n\tS_GAMEEND\022#\n\007endInf"
  "o\030\001 \003(\0132\022.Protocol.PRoomEnd\"+\n\nS_ROOMBAC"
  "K\022\035\n\004room\030\001 \001(\0132\017.Protocol.PRoomB\033\252\002\030Goo"
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 1949, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "Protocol.S_ROOMSTART.mapName"));
        } else
          goto handle_unusual;
        continue;
...
class C_MOVE::_Internal {
 public:
  ...
  static const ::Protocol::PCellPos& frontpos(const C_MOVE* msg);
};
...
C_MOVE::_Internal::frontpos(const C_MOVE* msg) {
  return *msg->frontpos_;
}
...
void C_MOVE::clear_frontpos() {
  if (GetArenaForAllocation() == nullptr && frontpos_ != nullptr) {
    delete frontpos_;
  }
  frontpos_ = nullptr;
}
...
C_MOVE::C_MOVE(const C_MOVE& from)
  ...
  if (from._internal_has_frontpos()) {
    frontpos_ = new ::Protocol::PCellPos(*from.frontpos_);
  } else {
    frontpos_ = nullptr;
  }
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&frontpos_) -
    reinterpret_cast<char*>(&positioninfo_)) + sizeof(frontpos_));
}
...
inline void C_MOVE::SharedDtor() {
  ...
  if (this != internal_default_instance()) delete frontpos_;
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ptr = ctx->ParseMessage(_internal_mutable_frontpos(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* C_MOVE::_InternalSerialize(
  ...
  // .Protocol.PCellPos frontPos = 2;
  if (this->_internal_has_frontpos()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, _Internal::frontpos(this),
        _Internal::frontpos(this).GetCachedSize(), target, stream);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Protocol.C_MOVE)
  ...
  if (from._internal_has_frontpos()) {
    _internal_mutable_frontpos()->::Protocol::PCellPos::MergeFrom(from._internal_frontpos());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void C_MOVE::InternalSwap(C_MOVE* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(C_MOVE, frontpos_)
      + sizeof(C_MOVE::frontpos_)
      - PROTOBUF_FIELD_OFFSET(C_MOVE, positioninfo_)>(
...
void S_BOMBEND::clear_destroyitemcellposes() {
  destroyitemcellposes_.Clear();
}
...
S_BOMBEND::S_BOMBEND(const S_BOMBEND& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      ...
      destroyitemcellposes_(from.destroyitemcellposes_),
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_destroyitemcellposes(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<34>(ptr));
        } else
...
uint8_t* S_BOMBEND::_InternalSerialize(
  ...
  // repeated .Protocol.PCellPos destroyItemCellPoses = 4;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_destroyitemcellposes_size()); i < n; i++) {
    const auto& repfield = this->_internal_destroyitemcellposes(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(4, repfield, repfield.GetCachedSize(), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_BOMBEND)
  ...
  // repeated .Protocol.PCellPos destroyItemCellPoses = 4;
  total_size += 1UL * this->_internal_destroyitemcellposes_size();
  for (const auto& msg : this->destroyitemcellposes_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_BOMBEND)
  ...
  destroyitemcellposes_.MergeFrom(from.destroyitemcellposes_);
...
void S_BOMBEND::InternalSwap(S_BOMBEND* other) {
  ...
  destroyitemcellposes_.InternalSwap(&other->destroyitemcellposes_);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_endinfo(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<10>(ptr));
        } else
...
uint8_t* S_GAMEEND::_InternalSerialize(
  ...
  // repeated .Protocol.PRoomEnd endInfo = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_endinfo_size()); i < n; i++) {
    const auto& repfield = this->_internal_endinfo(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(1, repfield, repfield.GetCachedSize(), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_GAMEEND)
  ...
  // repeated .Protocol.PRoomEnd endInfo = 1;
  total_size += 1UL * this->_internal_endinfo_size();
  for (const auto& msg : this->endinfo_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void S_GAMEEND::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<S_GAMEEND *>(to)->MergeFrom(
      static_cast<const S_GAMEEND &>(from));
}


void S_GAMEEND::MergeFrom(const S_GAMEEND& from) {
...
void S_GAMEEND::InternalSwap(S_GAMEEND* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  endinfo_.InternalSwap(&other->endinfo_);
}
...
class S_ROOMBACK::_Internal {
 public:
  static const ::Protocol::PRoom& room(const S_ROOMBACK* msg);
};

const ::Protocol::PRoom&
S_ROOMBACK::_Internal::room(const S_ROOMBACK* msg) {
  return *msg->room_;
}
void S_ROOMBACK::clear_room() {
  if (GetArenaForAllocation() == nullptr && room_ != nullptr) {
    delete room_;
  }
  room_ = nullptr;
}
S_ROOMBACK::S_ROOMBACK(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:Protocol.S_ROOMBACK)
}
S_ROOMBACK::S_ROOMBACK(const S_ROOMBACK& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_room()) {
    room_ = new ::Protocol::PRoom(*from.room_);
  ...
  // @@protoc_insertion_point(copy_constructor:Protocol.S_ROOMBACK)
}

inline void S_ROOMBACK::SharedCtor() {
room_ = nullptr;
}

S_ROOMBACK::~S_ROOMBACK() {
  // @@protoc_insertion_point(destructor:Protocol.S_ROOMBACK)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void S_ROOMBACK::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete room_;
}

void S_ROOMBACK::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void S_ROOMBACK::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.S_ROOMBACK)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* S_ROOMBACK::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* S_ROOMBACK::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.S_ROOMBACK)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.S_ROOMBACK)
  return target;
}

size_t S_ROOMBACK::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_ROOMBACK)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData S_ROOMBACK::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    S_ROOMBACK::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*S_ROOMBACK::GetClassData() const { return &_class_data_; }

void S_ROOMBACK::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<S_ROOMBACK *>(to)->MergeFrom(
      static_cast<const S_ROOMBACK &>(from));
}


void S_ROOMBACK::MergeFrom(const S_ROOMBACK& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_ROOMBACK)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void S_ROOMBACK::CopyFrom(const S_ROOMBACK& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.S_ROOMBACK)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool S_ROOMBACK::IsInitialized() const {
  return true;
}

void S_ROOMBACK::InternalSwap(S_ROOMBACK* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(room_, other->room_);
}

::PROTOBUF_NAMESPACE_ID::Metadata S_ROOMBACK::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Protocol_2eproto_getter, &descriptor_table_Protocol_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::Protocol::S_ROOMBACK*
Arena::CreateMaybeMessage< ::Protocol::S_ROOMBACK >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::S_ROOMBACK >(arena);
}
